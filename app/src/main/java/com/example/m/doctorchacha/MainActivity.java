...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener , FragmentReminder.OnFragmentInteractionListener , com.example.m.doctorchacha.Nearbyhosp.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTaskDescription( new ActivityManager.TaskDescription("Doctor ChaCha",bitmap));

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle("Doctor ChaCha");
